...
class StoreSelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("เลือกร้านอาหาร", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        centerTitle: true,
        actions: [
          IconButton(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const Center(
              child: Text("ยังไม่มีร้านค้าเปิดให้บริการในขณะนี้", style: TextStyle(color: Colors.grey, fontSize: 16)),
            );
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              String storeName = store['store_name'] ?? 'ไม่ระบุชื่อร้าน';
  ...
  Widget _buildStoreCard(BuildContext context, String storeId, String storeName) {
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.storefront, size: 32, color: Color(0xFF1D5A5D)),
                  ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text("รออยู่ $queueCount คิว", style: const TextStyle(color: Colors.orange, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ],
                    ),
